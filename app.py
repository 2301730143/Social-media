...
def generate_hashtags(topic):
    ...
    Author: UjjwaTripathi (2301730l43) 
    """
    import random
...
def main():
    ...
    Developed by: UjjwaTripathi (2301730l43) 
    """
    
    # Header
    st.markdown('<h1 class="main-header">🚀 Social Media Content Generator</h1>', 
                unsafe_allow_html=True)
    st.markdown('<p class="sub-header">Powered by AI | Developed by UjjwaTripathi (2301730l43) </p>', 
                unsafe_allow_html=True)
        ...
        if topic:
            with st.spinner("🤖 AI is generating your content... Please wait."):
                try:
                    ...
                    # Footer
                    st.divider()
                    st.caption("Content generated by AI | Created by UjjwaTripathi (2301730l43) ")
